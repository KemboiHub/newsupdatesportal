...
<?php
  ...
  if(isset($_SESSION['userId'])) {
    ...
    // Retrieve user's name and email from database
    $query = mysqli_query($con, "SELECT name, email FROM tbllogin_form WHERE id = '$userId'");
    ...
    // Set default name and email values
    $name = "";
    $email = "";
  }
?>
      ...
      <div class="card-body">
        ...
        <input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['token']); ?>">
          ...
          <!-- <div class="form-group">
            <input type="text" name="name" class="form-control" value="<?php echo htmlentities($name); ?>" placeholder="Enter your fullname" required>
          </div>

          <div class="form-group">
            <input type="email" name="email" class="form-control" value="<?php echo htmlentities($email); ?>" placeholder="Enter your Valid email" required>
          </div> -->
