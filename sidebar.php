  <div class="col-md-4">
   ...
   <!-- Side Widget -->
          <div class="card my-4">
            <h5 class="card-header">Trending  News</h5>
            <div class="card-body">
                      <ul >
          <?php
          $query1=mysqli_query($con,"select tblposts.id as pid,tblposts.PostTitle as posttitle from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId  order by viewCounter desc limit 8");
